<template>
  ...
  <main class="container mt-12 grid grid-cols-6 gap-16">
    <section class="main-content">
      <div class="gallery-wrapper">
        <section class="thumb-wrapper">
          <img
            :src="`http://localhost:8080/bengkelbe/${data.image.file_path}`"
            alt=""
            class="gallery-thumb"
          />
        </section>
      ...
      <article class="flex flex-col gap-12">
        ...
        <section class="flex flex-col gap-4">
          <h1 class="text-[24px] font-semibold uppercase">Lokasi Motoclub</h1>
          <div>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5679972.132502256!2d-93.27930727499997!3d43.00367409999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8838637ad2926ad5%3A0xc57def69ec2b81c!2sMonro%20Muffler%20Brake%20%26%20Service!5e1!3m2!1sid!2sid!4v1725365448915!5m2!1sid!2sid"
              class="w-full"
              height="450"
              style="border: 0"
              allowfullscreen=""
    ...
    <aside class="side-nav">
      <section class="flex flex-col gap-4">
        <h1 class="text-4xl font-semibold">{{ data.produk_name }}</h1>
        <section class="flex items-center justify-between">
          ...
          >
            ...
            <p class="text-[16px] font-medium text-mainn-50"></p>
          </div>
        </section>
      </section>
      <section
      ...
      <section class="flex justify-between">
        ...
        <div class="flex items-center gap-2">
          ...
          />
          <p class="font-semibold text-zinc-400">Paket tersedia</p>
        </div>
      </section>
      <UButton
...
const selectedImage = ref(data.image.file_path);
...
.img-gallery {
  @apply col-span-6 h-[500px] w-[500px] rounded-md border-2 border-white object-cover object-center;
}
.thumb-wrapper {
  @apply col-span-2 flex h-fit flex-wrap justify-start gap-2;
}
.gallery-thumb {
  @apply h-[70px] w-[70px] cursor-pointer rounded-sm border-2 border-transparent object-cover p-1 transition-all duration-300;
